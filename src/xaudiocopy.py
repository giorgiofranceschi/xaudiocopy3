...
class FileChooser:
	...
	def __init__(self, is_folder):
		...
		self.dlgFileChooser = Gtk.FileChooserDialog(None, None, Gtk.FileChooserAction.OPEN,
							(Gtk.STOCK_CANCEL, Gtk.ResponseType.CANCEL,
								Gtk.STOCK_OPEN, Gtk.ResponseType.OK))
		self.dlgFileChooser.set_default_response(Gtk.ResponseType.OK)
		self.dlgFileChooser.set_position(Gtk.WindowPosition.CENTER_ALWAYS)
		...
		if is_folder:
			...
			self.dlgFileChooser.set_action(Gtk.FileChooserAction.SELECT_FOLDER)
			...
			self.dlgFileChooser.set_action(Gtk.FileChooserAction.OPEN)
			self.dlgFileChooser.set_select_multiple(True)
...
class FileTable:
	...
	def __init__(self, builderXAC):
		...
		self.tvSelection.set_mode(Gtk.SelectionMode.MULTIPLE)
